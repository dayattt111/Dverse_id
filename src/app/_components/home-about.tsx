          ...
          <Grid size={{ xs: 12, md: 7 }} sx={{ pr: { xs: 0, md: 6 } }}>
            ...
            <Box sx={{ position: 'relative', zIndex: 2 }}>
              ...
              >
                ...
                <strong>Himpunan Mahasiswa Teknik Informatika dan Komputer Politeknik Negeri Ujung Pandang.</strong>.
              </Typography>
              <Typography
                sx={{
                  color: 'text.secondary',
                ...
                >
                  ...
                  >
                    ...
                    <Typography sx={{ fontWeight: 600, color: 'primary.main', fontSize: '0.95rem' }}>
                      Tema: “GreenTech Era: Explore the Future of Eco-Digital Innovation”
                    </Typography>
                  </Box>
                </Box>
              </motion.div>
