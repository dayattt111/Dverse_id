...
const timelineEvents = [
  {
    ...
    description: 'Pendaftaran peserta Seminar dan Hackathon resmi dibuka.',
  ...
  },
  {
    ...
    description: 'Batas akhir pendaftaran tim Hackathon. Pastikan tim kamu sudah terdaftar.',
    status: 'upcoming' as const,
  },
  {
    id: 3,
    ...
    description: 'Briefing dan penjelasan teknis untuk seluruh peserta Hackathon.',
    status: 'upcoming' as const,
  },
  {
    id: 4,
    ...
    description: 'Hari pertama: Seminar dengan keynote speakers dan panel diskusi GreenTech.',
    status: 'upcoming' as const,
  },
  {
    id: 5,
    ...
    description: 'Kompetisi hackathon selama 48 jam untuk membangun solusi GreenTech inovatif.',
    status: 'upcoming' as const,
  },
  {
    id: 6,
    ...
    description: 'Presentasi final, penilaian juri, dan pengumuman pemenang Hackathon.',
    status: 'upcoming' as const,
  },
]
