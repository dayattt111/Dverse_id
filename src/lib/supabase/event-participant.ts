...
export async function registerEventParticipant(participant: Omit<IEventParticipant, 'id' | 'status' | 'createdAt' | 'updatedAt'>) {
  const { data, error } = await supabase
    ...
    .insert({
      ...
      registration_type: participant.registrationType || 'individual',
      team_member_name: participant.teamMemberName || null,
      team_member_email: participant.teamMemberEmail || null,
      team_member_phone: participant.teamMemberPhone || null,
      team_member_institution: participant.teamMemberInstitution || null,
      team_member_pic_ktm: participant.teamMemberPicKtm || null,
      pic_ktm: participant.picKtm || null,
...
function transformFromDB(data: Record<string, unknown>): IEventParticipant {
  return {
    ...
    registrationType: data.registration_type as 'individual' | 'team' | undefined,
    teamMemberName: data.team_member_name as string | undefined,
    teamMemberEmail: data.team_member_email as string | undefined,
    teamMemberPhone: data.team_member_phone as string | undefined,
    teamMemberInstitution: data.team_member_institution as string | undefined,
    teamMemberPicKtm: data.team_member_pic_ktm as string | undefined,
    picKtm: data.pic_ktm as string | undefined,
