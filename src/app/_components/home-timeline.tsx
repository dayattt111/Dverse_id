...
const timelineEvents = [
  ...
  },
  {
    ...
    description: 'Pendaftaran tim/individu resmi dibuka. Segera daftarkan tim kamu!',
    status: 'upcoming' as const,
  },
  {
    id: 3,
    ...
    description: 'Batas akhir pendaftaran Seminar. Pastikan kamu sudah terdaftar sebelum tanggal ini.',
    status: 'upcoming' as const,
  },
  {
    id: 4,
    date: '9 Mei 2026',
    title: 'Kegiatan Seminar D-Verse',
    description: 'Kegiatan Seminar D-Verse dilaksanakan',
    status: 'upcoming' as const,
  },
  {
    id: 5,
    ...
    description: 'Batas akhir pendaftaran Lomba. Pastikan kamu sudah terdaftar sebelum tanggal ini.',
    status: 'upcoming' as const,
  },
  {
    id: 6,
    date: '16 Mei 2026',
    title: 'Kegiatan Competitive Programming D-Verse',
    description: 'Kegiatan Competitive Programming D-Verse dilaksanakan',
    status: 'upcoming' as const,
  }
]
